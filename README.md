...
* [Some Assembly Required](https://github.com/hackclub/some-assembly-required) - An approachable introduction to Assembly and the lowest levels of your computer (written by teenagers!).
