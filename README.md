...
* [senseBox](https://www.sensebox.de/en/) - The senseBox is a do-it-yourself kit for stationary and mobile sensor stations. Kids are able to collect environmental data using sensors for climate (weather, air quality), transport (traffic density or noise pollution) and many more phenomena to find out more about the environment and learn programming with [Arduino](https://www.arduino.cc/).
